...
<!-- //for-mobile-apps -->
<link href="sources/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
...
<script type="text/javascript" src="sources/js/move-top.js"></script>
<script type="text/javascript" src="sources/js/easing.js"></script>
	...
	<div class="footer-botm">
			<div class="container">
				...
				<div class="payment-w3ls">
					<img src="sources/images/card.png" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<script src="sources/js/minicart.min.js"></script>
<script>
	// Mini Cart
...
<!-- main slider-banner -->
<script src="sources/js/skdslider.min.js"></script>
<link href="sources/css/skdslider.css" rel="stylesheet">
<script type="text/javascript">
		jQuery(document).ready(function(){
